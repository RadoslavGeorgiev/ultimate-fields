...
class Container {
	...
	public function enqueue_scripts() {
		...
		ultimate_fields()
			...
			->localize( 'container_issues_fixed',  __( 'Hooray, all issues have been fixed. You try saving again.', 'ultimate-fields' ) )
	 ...
	 * @since 3.0
	 *
	 * @param Ultimate_Fields\Pro\Form_Object $object The object to check for compatability with.
	 * @return bool
	 */
